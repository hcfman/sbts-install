...
APP_CHECKSUM="4836f91a26a86dbe7a57c4bfcd8fee49"
...
install_secure() {
    ...
    if ! sudo -H -u "$SUDO_USER" cp -p -r resources/secure/multi-secure.py resources/secure/start_secure.sh resources/secure/multi_secureparse resources/secure/sbts-draw.py "$SUDO_USER_HOME/sbts-secure" ; then
